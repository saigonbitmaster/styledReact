...
export const EnIcon = () => (
  <SvgIcon viewBox="0 0 473.677 473.677">
    <g>
      ...
      <polygon fill="#C42126" points="101.793,431.36 371.888,431.36 371.902,431.345 101.778,431.345 	" />
      <path fill="#C42126" d="M236.837,0c-4.652,0-9.267,0.168-13.848,0.43h27.699C246.103,0.168,241.489,0,236.837,0z" />
    ...
    <path fill="#283991" d="M231.941,0.123C110.574,2.592,11.654,96.301,1.008,215.5h230.937V0.123H231.941z" />
    <g>
      <polygon
        fill="#EFEFEF"
...
export default function LanguageButton(props): ReactElement {
